...
received particular attention. Within this research body there
...
Indeed, a recent systematic review of 16 cycling specific
...
However, use of walking and cycling for
...
appears to have increased over the same period - from 37 to 53 miles (ibid.) - perhaps partly due
...
Fear of death or serious injury when walking and
cycling is a major barrier to uptake 
(Fishman et al., 2012; Lorenc et al., 2008).
This may be rational; whilst the balance between the risks
and reward from cycling may appear at first glance to be
straightforward, but this is not the case. Whilst all-cause
mortality estimates suggest switching from car to bicycle
use will result in 3-14 months of additional life from the
increase in physical activity compared with just 5-9 days
lost from traffic accidents (de Hartog 2010), risk from
traffic accidents was found to increase if promotion of the
switch from car to bicycle occurred among older rather than
younger drivers . Compared with travelling the same distance
by car, the risk of death from travelling one kilometre on
foot or by bicycle is more than 17 times higher (Davies,
2014). The geographical and demographic distribution of
...
results in relatively unambiguous benefits in some context,
such as it the case for the cycle hire scheme in Barcelona
(Rojas-Rueda et al, 2011), in the case of London, for women,
the harms from traffic accidents may outweigh the benefits
...
factors associated with the prevalance of bicycle use (e.g.
...
interventions around road safety was provided by 
...
accidents that occurred within the case study zone of West Yorkshire (fig. x).
...
![Anomaly in the age distribution of cyclist casualties in West Yorkshire, compared with the UK](figure/unnamed-chunk-6.png) 
...
serious injury rate (11.2 serious injuries
...
an imperfect proxy, but one that allows estimation of risk at an unusually high level
