...
# download("https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/401298/quarterly-estimates-jul-to-sep-2014.zip", destfile = "stats19-2014.zip")
...
# ac <- read.csv("stats19data/Accidents0513.csv")
# vt <- read.csv("stats19data/Vehicles0513.csv")
# ca <- read.csv("stats19data/Casualties0513.csv") # casualties
#
