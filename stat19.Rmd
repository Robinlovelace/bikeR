...
The relative proportions of road traffic accidents are roughly the same across A, B and U (Unclassified) roads between those that involve cyclists and those that do not (Fig. 8). The exception to this is the number of incidents occurring on the motorway, which is to be expected as cycling on motorways is not permitted (Fig. 8).
...
where bicycle incidents almost happened and has
...
Kroon, P. (1990). Bicycle accidents in Gothenburg 1983-84. Ortopedisk kirurgi. Doctoral thesis. 
