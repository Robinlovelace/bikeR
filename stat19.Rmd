...
Fear of death or serious injury when
...
"busy rush hour conditions" being particularly offputting
...
Safety concerns have been found to the most important
barrier to cycling uptake in many contexts
(Fishman et al., 2012; Reynolds et al., 2009; Lorenc et al., 2008).
...
Thus proportion of trips made by bicycle for each age group was
...
from local surveys, will help prioritise funding to tackle such 'danger hotspots'
and ensure that the wide-ranging health benefits of cycling can be enjoyed everywhere.
We thus recommend the same type of analysis conducted in this paper
be replicated in other areas where ambitious targets and large funding
grants for increased cycling have been allocated.
