...
```{r fig.cap="Cyclist and non cyclist casualties from road traffic incidents, 2005 - 2012 in West Yorkshire, by age and severity. Note the variably sized age bins, which down-play the relative risks of road crashes for young people", fig.width=10, fig.height=13, echo=FALSE}
library(png)
library(grid)
...
```{r fig.cap="Risk of cycling per billion kilometres across West Yorkshire. The circles represent 5 km bands from the city centres which are deemed 'cyclable' by the majority of the population", fig.width=10, fig.height=13, echo=FALSE}
library(png)
library(grid)
